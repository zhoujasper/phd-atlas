import type { AuthSession, TeamMemberRelationships, TeamPermissionDefaults, TeamRole } from '../../api/phdApi'
...
export function hasTeamDiscoverAccess(
  ...
  _relationships?: TeamMemberRelationships | null,
  _defaults?: TeamPermissionDefaults | null,
) { return false }
